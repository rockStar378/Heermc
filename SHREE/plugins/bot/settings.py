...
from SHREE.utils.decorators.admins import ActualAdminCB
from SHREE.utils.decorators.language import language, languageCB
from SHREE.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from SHREE.utils.inline.start import private_panel
...
@app.on_callback_query(filters.regex("shiv_KAVYA") & ~BANNED_USERS)
@languageCB
